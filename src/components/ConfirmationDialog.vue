...
<template>
  <div v-if="isVisible"
    class=" bg-white p-6 h-36 w-11/12 sm:w-96 md:w-96 text-center  text-gray-600 rounded-xl shadow-2xl border shadow-violet-500 border-violet-200 fixed inset-1/2 -translate-x-1/2 -translate-y-1/2 z-50">
